        ...
        dogs: [
            {
                ...
                description: "Aurora has a bit of a troublesome history so she takes a little while to warm up to people. She's a really smart dog - but also a REALLY stubborn dog:) She's not great with other animals, and sometimes gets overwhelmed when she meets new peopole."
            }
        ],
        other: []
    }
...
function ProfileScreen({navigation}: {navigation: any}) {
    return (
        <View style={styles.background}>
            <Image style={styles.profileImage} source={require("../../assets/profilePic.png")}/>
