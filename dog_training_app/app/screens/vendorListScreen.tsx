...
const Item = ({name, triggers, phone, dates, navigation}: {name: any, triggers: any, phone: any, dates: any, navigation: any}) => (
    <View>
...
function VendorListScreen({route, navigation}: {route: any, navigation: any}) {
    ...
    const renderItem = ({ item }: {item: any}) => (
        ...
        <Item name={item.name} triggers={item.triggers} phone={item.phone} dates={item.dates} navigation={navigation}/> : null
    );
