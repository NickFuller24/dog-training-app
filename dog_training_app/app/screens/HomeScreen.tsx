            ...
            >
                ...
                >
                    <TouchableOpacity style={styles.navBarContainerButton}>
                        <View style={[styles.navBarIconContainer, {backgroundColor: 'lightgreen'}]}>
                            <Image
                    ...
                    <TouchableOpacity style={styles.navBarContainerButton}>
                        <View style={[styles.navBarIconContainer, {backgroundColor: 'orange'}]}>
                            <Image
                    ...
                    <TouchableOpacity style={styles.navBarContainerButton}>
                        <View style={[styles.navBarIconContainer, {backgroundColor: 'pink'}]}>
                            <Image
                    ...
                    >
                        <View style={[styles.navBarIconContainer, {backgroundColor: 'lightblue'}]}>
                            <Image
